      ...
      <main className="flex-1 pt-32 pb-24 max-w-[1100px] mx-auto px-4 sm:px-8 w-full">
        ...
        <div className="mt-10 text-sm text-gray-500">
          {lang === 'tr' ? (
            <>
              Ürün detayları için{' '}
              <Link href="/products" className="text-[#8EF0B5] hover:text-white transition-colors">
                ürünler
              </Link>
              {' '}veya{' '}
              <Link href="/case-studies" className="text-[#8EF0B5] hover:text-white transition-colors">
                vaka çalışmaları
              </Link>
              {' '}sayfasına göz atın.
            </>
