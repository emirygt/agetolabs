      ...
      <main className="flex-1 relative z-10 max-w-[1200px] mx-auto w-full px-8 pb-32">
        ...
        <div className="bg-[#13151A] border border-white/10 rounded-[40px] p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row justify-center gap-4">
            <Link href={`/${lang}/ecosystem`} className="h-14 inline-flex items-center justify-center rounded-full bg-white/10 px-8 text-lg font-bold text-white hover:bg-white/20 transition-all border border-white/10">
