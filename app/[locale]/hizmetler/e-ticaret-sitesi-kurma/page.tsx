...
export default async function EticaretSitesiKurmaPage({
  ...
  const serviceJsonLd = {
    ...
    offers: {
      ...
      priceCurrency: 'TRY',
      url: `https://agetolabs.com/${locale}/hizmetler/e-ticaret-sitesi-kurma`,
    },
  };
  ...
  const breadcrumbJsonLd = {
    ...
    '@type': 'BreadcrumbList',
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Anasayfa', item: `https://agetolabs.com/${locale}` },
      { '@type': 'ListItem', position: 2, name: 'Hizmetler', item: `https://agetolabs.com/${locale}/hizmetler` },
      { '@type': 'ListItem', position: 3, name: 'E-ticaret Sitesi Kurma', item: `https://agetolabs.com/${locale}/hizmetler/e-ticaret-sitesi-kurma` },
    ],
  };
