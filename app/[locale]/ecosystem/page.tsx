      ...
      <main className="flex-1 relative z-10 max-w-[1400px] mx-auto w-full px-8 pb-32 space-y-32">
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex gap-4">
                <Link href={`/${lang}/products/agento-eczaport`} className="h-12 inline-flex items-center justify-center rounded-full bg-white/10 px-6 text-sm font-semibold text-white hover:bg-white/20 transition-all border border-white/5">
                  {lang === 'tr' ? "Eczaport'u İncele" : 'Explore Eczaport'}
                </Link>
                <Link href={`/${lang}/products/agento-pharm-ia`} className="h-12 inline-flex items-center justify-center rounded-full bg-white/10 px-6 text-sm font-semibold text-white hover:bg-white/20 transition-all border border-white/5">
        ...
        <div className="text-center pt-20">
          ...
          <div className="flex justify-center flex-wrap gap-4">
            <FlyingIconsButton href={`/${lang}/products`} paddingY={14} paddingX={32}>
              {lang === 'tr' ? 'Ürünlerimizi Keşfedin' : 'Discover Our Products'}
            </FlyingIconsButton>
            <Link href={`/${lang}/contact`} className="h-14 inline-flex items-center justify-center rounded-full bg-white/10 px-10 text-lg font-bold text-white hover:bg-white/20 transition-all">
