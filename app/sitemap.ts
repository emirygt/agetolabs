...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/hizmetler`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${siteUrl}/hizmetler/eticaret-dijitallesme`, lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${siteUrl}/hizmetler/e-ticaret-sitesi-kurma`, lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
